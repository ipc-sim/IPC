...
if(NOT TARGET CCDWrapper)
  ...
  if(IPC_WITH_FPRP)
    set(CCD_WRAPPER_WITH_RP  ON CACHE BOOL "Enable floating-point root parity method" FORCE)
  else()
    set(CCD_WRAPPER_WITH_RP OFF CACHE BOOL "Enable floating-point root parity method" FORCE)
  endif()
